...
Проект разработан в учебных целях для практики разработки SPA-приложений на React и построения REST API на Node.js / Express.

Приложение демонстрирует базовые принципы построения CRUD-систем.

## 🌐 Live Demo

Frontend:  
https://mini-crm-dashboard.netlify.app/
...
```
git clone https://github.com/vasilyefff/mini-crm
```
